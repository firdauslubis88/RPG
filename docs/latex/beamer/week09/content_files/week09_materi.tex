...
\begin{frame}[t, fragile]
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            \centering
            \includegraphics[height=0.65\textheight]{../../diagrams/uml-comparison.pdf}
...
\begin{frame}[t, fragile]
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            \centering
            \includegraphics[height=0.7\textheight]{../../diagrams/game-loop-pattern.pdf}
        \end{column}
    \end{columns}
    \end{spacing}
\end{frame}
...
\begin{frame}[t, fragile]
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.50\textwidth}
            \centering
            \includegraphics[height=0.65\textheight]{../../diagrams/performance-comparison.pdf}
        \end{column}
    \end{columns}
    \end{spacing}
\end{frame}
...
\begin{frame}[t, fragile]
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            \centering
            \includegraphics[height=0.7\textheight]{../../diagrams/object-drilling.pdf}
        \end{column}
    \end{columns}
    \end{spacing}
\end{frame}
...
\begin{frame}[t, fragile]
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            \centering
            \includegraphics[height=0.7\textheight]{../../diagrams/singleton-pattern.pdf}
        \end{column}
    \end{columns}
    \end{spacing}
\end{frame}
...
\begin{frame}[t, fragile]
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \centering
            \includegraphics[height=0.7\textheight]{../../diagrams/uml-comparison.pdf}
        \end{column}
...
\begin{frame}[t, fragile]
    ...
    \begin{spacing}{0.85}
        ...
        \centering
        \includegraphics[height=0.5\textheight]{../../diagrams/performance-comparison.pdf}
