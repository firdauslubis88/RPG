...
\begin{tikzpicture}[
    ...
    arrow/.style={->,>=stealth,thick},
    dashed/.style={->,>=stealth,thick,dashed,blue}
]
    ...
    \draw[dashed] (logic03) -- (mgr03) node[midway,above,sloped,font=\scriptsize,blue] {getInstance()};
    \draw[dashed] (hud03) -- (mgr03) node[midway,below,sloped,font=\scriptsize,blue] {getInstance()};
